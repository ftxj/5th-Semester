...
$ns duplex-link $n5 $n0 8.0Mb 1ms DropTail
$ns queue-limit $n5 $n0 30
#
#Error Model for Link from $n5to $n0 
#
set em_n5ton0 [new ErrorModel]
$em_n5ton0 unit Pkt
$em_n5ton0 set rate_ -1.0
$em_n5ton0 ranvar [new RandomVariable/Uniform]
$em_n5ton0 drop-target [new Agent/Null]
$ns lossmodel $em_n5ton0 $n5 $n0
...
$cbr6 attach-agent $udp12
	...
	$cbr6 set rate_ 100.0Mb
	$cbr6 set interval_ 0.005
	$cbr6 set maxpkts_ 1000.0
